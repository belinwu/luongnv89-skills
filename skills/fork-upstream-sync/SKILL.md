...
If the working tree is dirty, stash first, sync, then pop the stash.
...
3. On each conflict, resolve files. When upstream and your feature both added valid code, keep **both** (union), not either/or.
