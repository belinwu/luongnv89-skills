...
| <a id="security-setup"></a>[**security-setup**](skills/security-setup/) | 1.2.2 | ![high](https://img.shields.io/badge/high-red) | Local-first security hardening with pre-commit hooks, offline scanners, reports, and gated CI |
